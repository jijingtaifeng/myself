...
let toastPannel = {
  ...
  showDialog: function (data) {
    let self = this;
    this.setData({ '_toast_.isHide': true, '_toast_.content': data.content, '_toast_.confirmtext': data.confirmtext});
  },

  closedialog: function () {
    this.setData({ '_toast_.isHide': false })
  }
